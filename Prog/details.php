...
<body class="row">
  ...
  <div class="col-md-9">
    <div class="card mb-3" style="">
        <div class="row g-0">
          <?php include 'app/detailsController.php'; ?>
          <?php if (!empty($producto['data'])): ?>
          
          <div class="col-md-4">
          
            <img src="<?php echo $producto['data']['cover'] ?? 'https://ui-avatars.com/api/?name=' . urlencode($producto['data']['name'] ?? 'Producto'); ?>" class="card-img-top" alt="<?php echo $producto['data']['name'] ?? 'Nombre no disponible'; ?>">
          <div class="card-body">
